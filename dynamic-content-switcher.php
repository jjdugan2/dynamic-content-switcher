...
?>
    <div class="wrap">
        ...
        <form method="post" action="options.php">
            ...
            <button type="button" id="dcs_add_headline" style="margin-top:5px;">Add Headline</button><span id="dcs_headlines_reminder" style="margin-left:10px;"></span>
            ...
            <button type="button" id="dcs_add_image" style="margin-top:5px;">Add Image</button><span id="dcs_images_reminder" style="margin-left:10px;"></span>
            ...
            <button type="button" id="dcs_add_cta" style="margin-top:5px;">Add CTA</button><span id="dcs_ctas_reminder" style="margin-left:10px;"></span>
